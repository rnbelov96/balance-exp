...
const checkRangeEl = document.querySelector('.calc__range_check') as HTMLInputElement;
const caseRangeEl = document.querySelector('.calc__range_case') as HTMLInputElement;
...
const formatResult = (result: string) => `${result.substring(0, 1)} ${result.substr(1, 3)} ${result.substr(4, 3)} ₽`;
